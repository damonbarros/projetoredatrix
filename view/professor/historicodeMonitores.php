...
?>
    ...
    <main class="main_cadastro">
        ...
        <form action="../../controller/historico.php" method="POST" class="form_cadastro" enctype="multipart/form-data">

        <label for="nome_monitor"><input type="text" id="nome_monitor" name="nome_monitor" placeholder="Nome do monitor" required></label>
        <label for="foto">Foto do Monitor</label>
        <label for=""><input type="file" name="file" id="foto" required></label>
